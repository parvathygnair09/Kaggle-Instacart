...
#### Pattern of Orders by Hour of the Day
...
#### Distribution of orders druing each Weekday and Hour
...
#### Top 50 Most Ordered From Aisles

```{r, echo = FALSE, warning = FALSE, fig.width= 10}
## Similar analysis as above with word cloud
## Word Cloud
...
wordcloud2::wordcloud2(aisle.freq %>% mutate(freq=(freq)^0.7), size = 0.5, maxRotation = 0, minRotation = 0)
